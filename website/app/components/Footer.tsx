        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="font-space-grotesk font-bold text-xl text-white">Levelin</span>
            </Link>
            <p className="text-gray-400 text-sm">
              A decentralized proof-of-work platform on Solana blockchain that enables professionals to prove expertise through challenges.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Technology</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Whitepaper</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Team</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Contact</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Press Kit</a></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-levelin-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} Levelin. All rights reserved.</p>
